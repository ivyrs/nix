{
  ...
  # niri's config.kdl is all-or-nothing: once home-manager manages it, niri
  # no longer falls back to its bundled default. So this is niri's own
  # upstream default config verbatim (kept fully commented/annotated on
  # purpose — uncomment sections here as alder's setup grows) with only the
  # terminal swapped from alacritty to ghostty (den.aspects.ghostty).
